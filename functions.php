...
add_action('wp_enqueue_scripts', 'lk_register_styles');


function lk_register_scripts()
{
    ...
    wp_enqueue_script('followandrew-bootstrap', get_template_directory_uri() . "/assets/js/main.js", array(), '1.0', true);
}
add_action('wp_enqueue_scripts', 'lk_register_scripts');
